...
export interface MaskRevealUpProps {
  ...
  /**
   * When true, wait for the home intro/preloader to finish before playing.
   * Defaults to false so other pages keep their normal reveal timing.
   */
...
export default function MaskRevealUp({
  ...
  const introReady = !waitForIntro || introComplete;
  const play =
    (!triggerOnView || inView) && !shouldReduceMotion && introReady;
